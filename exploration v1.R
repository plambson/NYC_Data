...
data <- read.csv("C:/Users/PL77279/Desktop/NYC Parking Data/Parking_Violations_Issued_-_Fiscal_Year_2016.csv", 
                 stringsAsFactors = F,
                 nrows = 1000000)
...
a+geom_bar(fill="#3E8EDE")+
  ...
  labs(title= "Enorcement by Hour and Law", x= "Count", y="Violation Hour")
...
a+geom_bar(fill="#3E8EDE")+
  ...
  theme_minimal()+
  facet_grid(Law.Section~., scales="free")+
  labs(title= "Enorcement by DOW and Law", x= "Weekday 6=Sunday", y="Count")
...
a+geom_bar(fill="#3E8EDE")+
  ...
  theme_minimal()+
  facet_grid(Law.Section~., scales="free")+
  labs(title= "Enorcement by Month and Law", x= "Month", y="Count")
...
a+geom_bar(fill="#3E8EDE")+
  ...
  theme_minimal()+
  facet_grid(Law.Section~., scales="free")+
  labs(title= "Enorcement by Day of Month and Law", x= "Day of Month", y="Count")
...
a+geom_bar(fill="#3E8EDE")+
  ...
  theme_minimal()+
  facet_grid(Law.Section~., scales="free")+
  labs(title= "Enorcement by Date of Month and Law", x= "Date", y="Count")
